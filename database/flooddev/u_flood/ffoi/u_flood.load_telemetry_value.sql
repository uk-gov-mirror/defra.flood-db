-- Function: u_flood.load_telemetry_value()

-- DROP FUNCTION u_flood.load_telemetry_value();

CREATE OR REPLACE FUNCTION u_flood.load_telemetry_value()
  RETURNS trigger AS
$BODY$
begin
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION u_flood.load_telemetry_value()
  OWNER TO u_flood;
