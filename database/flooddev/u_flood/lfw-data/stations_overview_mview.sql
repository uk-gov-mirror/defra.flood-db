-- Materialized View: stations_overview_mview

DROP MATERIALIZED VIEW stations_overview_mview;

CREATE MATERIALIZED VIEW stations_overview_mview AS 
 SELECT s.rloi_id,
    s.telemetry_id,
    s.wiski_id,
...
ALTER TABLE stations_overview_mview
  OWNER TO u_flood;
